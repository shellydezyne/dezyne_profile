...
<head>
    ...
    <link href="<?php bloginfo('template_directory'); ?>/bootstrap1/bootstrap.min.css" rel="stylesheet"/>
  <linK href="<?php bloginfo('template_directory'); ?>/owl-carousel/owl.carousel.css" rel="stylesheet"/> <!-- Core Owl Carousel CSS File  *	v1.3.3 -->
  <linK href="<?php bloginfo('template_directory'); ?>/owl-carousel/owl.theme.css" rel="stylesheet"/> <!-- C
            ...
            <div id="page-nav-wrapper" class="page-nav-wrapper text-center">
                <div class="container">
                    <ul id="page-nav" class="nav page-nav list-inline">
                        <li><a href="<?php bloginfo('template_directory'); ?>/home #experiences-section">Experiences</a></li>
                        <li><a href="<?php bloginfo('template_directory'); ?>/home #education-section">Education</a></li>
                        <li><a href="<?php bloginfo('template_directory'); ?>/home #skills-section">Skills</a></li>
                        <li><a href="<?php bloginfo('template_directory'); ?>/home #testimonials-section">Testimonials</a></li>
                        <li><a href="<?php bloginfo('template_directory'); ?>/home #portfolio-section">Portfolio</a></li>
                        <li><a href="<?php bloginfo('template_directory'); ?>/home #contact-section">Contact</a></li>
