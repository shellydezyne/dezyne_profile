		...
		<section id="portfolio-section" class="portfolio-section section">
				...
				<div class="items-wrapper isotope row">
						<div class="item frontend col-md-3 col-xs-6 ">
								<div class="item-inner">
										<figure class="figure">
												<img class="img-responsive" src="<?php bloginfo('template_directory'); ?>/assets/images/portfolio/portfolio-1.jpg" alt="" />
										</figure>
						...
						<div class="item backend col-md-3 col-xs-6 ">
								<div class="item-inner">
										<figure class="figure">
												<img class="img-responsive" src="<?php bloginfo('template_directory'); ?>/assets/images/portfolio/portfolio-2.jpg" alt="" />
										</figure>
										<div class="content text-left">
												<h3 class="sub-title"><a href="#">Project Lorem Ipsum</a></h3>
						...
						<div class="item backend frontend col-md-3 col-xs-6 ">
								<div class="item-inner">
										<figure class="figure">
												<img class="img-responsive" src="<?php bloginfo('template_directory'); ?>/assets/images/portfolio/portfolio-3.jpg" alt="" />
										</figure>
										<div class="content text-left">
												<h3 class="sub-title"><a href="#">Project Lorem Ipsum</a></h3>
						...
						<div class="item frontend col-md-3 col-xs-6 ">
								<div class="item-inner">
										<figure class="figure">
												<img class="img-responsive" src="<?php bloginfo('template_directory'); ?>/assets/images/portfolio/portfolio-4.jpg" alt="" />
										</figure>
										<div class="content text-left">
												<h3 class="sub-title"><a href="#">Project Lorem Ipsum</a></h3>
						...
						<div class="item backend col-md-3 col-xs-6 ">
								<div class="item-inner">
										<figure class="figure">
												<img class="img-responsive" src="<?php bloginfo('template_directory'); ?>/assets/images/portfolio/portfolio-5.jpg" alt="" />
										</figure>
										<div class="content text-left">
												<h3 class="sub-title"><a href="#">Project Lorem Ipsum</a></h3>
						...
						<div class="item backend col-md-3 col-xs-6 ">
								<div class="item-inner">
										<figure class="figure">
												<img class="img-responsive" src="<?php bloginfo('template_directory'); ?>/assets/images/portfolio/portfolio-6.jpg" alt="" />
										</figure>
										<div class="content text-left">
												<h3 class="sub-title"><a href="#">Project Lorem Ipsum</a></h3>
						...
						<div class="item frontend col-md-3 col-xs-6 ">
								<div class="item-inner">
										<figure class="figure">
												<img class="img-responsive" src="<?php bloginfo('template_directory'); ?>/assets/images/portfolio/portfolio-7.jpg" alt="" />
										</figure>
										<div class="content text-left">
												<h3 class="sub-title"><a href="#">Project Lorem Ipsum</a></h3>
						...
						<div class="item frontend backend col-md-3 col-xs-6 ">
								<div class="item-inner">
										<figure class="figure">
												<img class="img-responsive" src="<?php bloginfo('template_directory'); ?>/assets/images/portfolio/portfolio-8.jpg" alt="" />
										</figure>
										<div class="content text-left">
												<h3 class="sub-title"><a href="#">Project Lorem Ipsum</a></h3>
